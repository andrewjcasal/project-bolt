            ...
            <div className="space-y-2 text-sm">
                ...
                <div className="flex-1 h-3 bg-gray-800/50 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ 
                      width: `${percentage}%`,
                      minWidth: '2px',
                      background: `linear-gradient(90deg, ${percentage >= 90 ? '#ef4444' : percentage >= 75 ? '#eab308' : '#22c55e'} 0%, ${percentage >= 90 ? '#dc2626' : percentage >= 75 ? '#ca8a04' : '#16a34a'} 100%)`
                    }}
                  />
                </div>
              ...
              <div className="flex flex-col gap-1.5 text-xs">
                <div className="flex justify-between text-gray-500">
                  <span>Used:</span>
                  <span>{formatNumber(usage.used)}</span>
                </div>
                <div className="flex justify-between text-gray-500">
                  <span>Limit:</span>
